package org.example.leetcode.lang.type;
...
public class IntegerConverter {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(converter.intArray2IntegerList(converter.ints));
        System.out.println(Arrays.toString(converter.intArray2IntegerArray(converter.ints)));
        System.out.println(Arrays.toString(converter.integerArray2IntArray(converter.integers)));
        System.out.println(converter.integerArray2IntegerList(converter.integers));
        System.out.println(Arrays.toString(converter.integerList2IntArray(converter.list)));
        System.out.println(Arrays.toString(converter.integerList2IntegerArray(converter.list)));
    }
}
